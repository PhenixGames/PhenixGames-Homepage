<template>
    ...
    <div class="white datenschutz">
        ...
        <p>BlackDayz<br />Aachener Str 12<br />10115 Berlin</p>
        <p>
            E-Mail-Adresse:
            <a href="mailto:Info@phenixgames.de">Info@phenixgames.de</a>.
        </p>
        ...
        <p>
            ...
            personenbezogene Daten an andere Stellen innerhalb unserer Organisation übermitteln oder
        ...
        <ul>
            ...
            <li>
                <strong
                    >Notwendige (auch: essentielle oder unbedingt erforderliche) Cookies:</strong
                >
            ...
            <li>
                ...
                Cookies im Regelfall auch im Rahmen der Reichweitenmessung eingesetzt sowie dann,
                wenn die Interessen eines Nutzers oder sein Verhalten (z.B. Betrachten bestimmter
                Inhalte, Nutzen von Funktionen etc.) auf einzelnen Webseiten in einem Nutzerprofil
        ...
        <ul class="m-elements">
            <li>
                ...
                Willow Road, Menlo Park, CA, 94025, USA, Mutterunternehmen: Facebook, 1 Hacker Way,
                Menlo Park, CA 94025, USA; Website:
            ...
            <li>
                <strong>YouTube:</strong> Soziales Netzwerk und Videoplattform; Dienstanbieter:
        ...
        <ul class="m-elements">
            <li>
                <strong>YouTube-Videos:</strong> Videoinhalte; Dienstanbieter: Google Ireland
...
<script>
import homepageNav from '../../components/homepage/nav.vue';
