<template>
    ...
    <div class="white impressum">
        ...
        <p>
            <a href="https://www.youtube.com/channel/UCcaZGaoo2h9oV5r7JfuEvvw" target="_blank"
        ...
        <p>
            ...
            AGB oder verpflichtende Belehrungen von Verbrauchern) handelt. Wir behalten uns vor, die
        ...
        <p>
            ...
            Internetauftritts Rechtsverstöße bemerken, bitten wir Sie uns auf diese hinzuweisen. Wir
            werden rechtswidrige Inhalte und Links nach Kenntnisnahme unverzüglich entfernen.
        </p>
    </div>
    <footerbody />
</template>
